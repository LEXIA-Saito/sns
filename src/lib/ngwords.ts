...
const BLOCK_WORDS = [
  ...
  "たいつふぇち", "ふとももふぇち",
  "くりとりす", "顔面騎乗", "寝取られ", "寝取り", "逆れいぷ", "ぐろ画像",
  "ぐろ動画", "ぐろ映像",
  "奴隷", "監禁", "陵辱", "凌辱", "ふたなり", "男の娘", "しょた", "ろり",
  "えろ同人", "異種姦", "sm拘束", "smぷれい",
  ...
  "放火", "通り魔", "無差別殺", "人を轢", "轢きます", "犯行予告",
  "完全犯罪", "証拠隠滅", "家を燃や", "焼き払", "火をつけてやる",
  "硫酸で煮", "硫酸をかけ", "骨を砕", "骨は砕", "こんくり詰め",
  "山に埋め", "海に沈め", "死体処理", "ばらばらにして",
  ...
  "ちょん公", "支那", "土人", "乞食", "nigger", "じゃっぷ",
  "毛唐", "三国人", "黒んぼ", "鬼畜", "あめかす", "黒人にき",
  "ほも", "おかま", "れず",
  // 人格・容姿への攻撃
  ...
  // 残虐な描写
  "圧殺", "惨殺", "斬首", "撲殺", "刺殺", "絞殺", "毒殺", "虐殺", "殺人",
  "溺死", "焼死", "死体", "首切り", "首をはね", "目玉をくり抜", "えぐり出",
  "人肉", "食人", "かにばりずむ", "拷問", "血祭り", "グロ画像", "死体遺棄",
  "眼球摘出", "臓器売買", "生体解剖", "内臓をえぐ", "死姦", "屍姦", "臓物",
  // 脅し文句
  "奥歯がたがた", "しりから手", "ぶっ飛ばす", "ぼこぼこにする", "制裁を加え",
  "生爪", "爪を剥", "爪の間に釘", "腹ぱん",
  "刺すぞ", "殴るぞ", "潰すぞ", "沈めるぞ",
  // 薬物
 ...
 */
const EXACT_BLOCK_WORDS = [
  "69", "水着", "ぶら", "sm", "ぐろ", "えぐ", "ntr",
  "にが", // 「ニガー」。伸ばし棒を落とすと「にが」になり、苦い・苦手と重なるため
  "ほすと", // ホスト名・ホストファミリー等で普通に使うため
];
...
const WARN_WORDS = [
  ...
  "儲け話", "うまい話", "お金を用意",
  "煽り", "びびってる", "へたくそ", "下手くそ", "しょぼい", "お触り",
  "ぐちゃぐちゃにし", "どろどろにし", "みきさーにかけて",
  "膵臓を食べ", "内臓を食べ", // 「君の膵臓をたべたい」は小説・映画の題名
